...
#  def statistic
#    @highlight = 'statistic'
#    @statistic = SteakFM::Statistic.new(cfm)
#  end
  ...
  def create
    if filename_invalid?
      ...
      feature = SteakFM::Feature.new(new_file_path, cfm)
...
#      redirect_to edit_documentation_feature_path(@feature.id)
#    else
#      feature = SteakFM::Feature.new(move_to_path, cfm)
#      feature.raw=(@feature.raw)
#      feature.save && @feature.destroy
#      redirect_to edit_documentation_feature_path(feature.id)
#    end
#  end
  ...
  def fetch_feature
    @feature = SteakFM::Feature.new(path, cfm)
  end
  ...
  def cfm
    @cfm ||= SteakFeatureManager.new(feature_dir_path, git_dir_path, read_config)
  end
